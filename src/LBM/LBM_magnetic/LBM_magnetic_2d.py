...
from src.LBM.LBM_collision import LBMCollisionHCZ2d
from src.LBM.utils import CellType, get_staggered_x, get_staggered_y


class LBMMagnetic2d(AbstractLBMMagnetic):
    rank = 2
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(LBMMagnetic2d, self).__init__(*args, **kwargs)
        self._Q = Q
        self._tau = tau
