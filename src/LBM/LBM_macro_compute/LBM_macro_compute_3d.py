...
class LBMMacroCompute3d(AbstractLBMMacroCompute):
    rank = 3
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(LBMMacroCompute3d, self).__init__(*args, **kwargs)
        self._Q = Q
        self._tau = tau
    ...
    def macro_compute(
        ...
        """
        ! Note for multiphase case, [rho] is a indicator for different phases and [density] the density
        ! However for regular case, [rho] is the density and [density] the None
        """
        dim = 3
